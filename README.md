...
- I used the TfidfVectorizer to convert the text into features, The Input_matrix contains the features for input ingredients, The new_matrix contains the features of input json file ingredients. 
